...
export class ProductOut extends Model<IProductOut, Partial<IProductOut>> implements Model {
...
export const ProductOutFactory = (sequelize: Sequelize) => {
	ProductOut.init(
		...
		{ sequelize, tableName: "salidaproducto", timestamps: true, paranoid: true }
	);
	return ProductOut;
};
